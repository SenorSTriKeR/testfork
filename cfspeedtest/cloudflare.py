...
UPLOAD_TESTS: TestSpecs = (
    ...
    TestSpec(1_000_000, 8, "1MB", TestType.Up),
    TestSpec(10_000_000, 6, "10MB", TestType.Up),
    TestSpec(25_000_000, 4, "25MB", TestType.Up),
    TestSpec(100_000_000, 2, "100MB", TestType.Up),
)
